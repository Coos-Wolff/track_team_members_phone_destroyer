...
public class EventServiceTest {
    ...
    public void testCreateNewEvent() {
        ...
        verify(eventMemberRepository, times(16))
    ...
    public void testEndEvent() {
        ...
        verify(memberRepository, times(16)).setTicketsAndPointsToZero(memberArgumentCaptor.capture());
        testMembers.forEach(testMember ->
                verify(eventHistoryRepository, times(16))
