...
public class ElderHistoryDemoted {
    ...
    private static EventHistory getTestElderHistoryDemoted1() {
        return EventHistory.builder()
                .id(1)
                .eventId(elderEventToKick1.getId())
                .eventName(elderEventToKick1.getName())
                .eventDate(elderEventToKick1.getEventDate())
    ...
    private static EventHistory getTestElderHistoryDemoted2() {
        return EventHistory.builder()
                .id(2)
                .eventId(elderEventToKick2.getId())
                .eventName(elderEventToKick2.getName())
                .eventDate(elderEventToKick2.getEventDate())
